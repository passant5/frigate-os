...
typedef struct _nnom_conv2d_Accelerator_layer_t
{
    nnom_layer_t super;
    nnom_3d_shape_t kernel;
    nnom_3d_shape_t stride;
    ...
    q7_t relu_max;
    q7_t relu_threshold;
    q7_t relu_negative_slope;
    
    nnom_layer_io_t mid_out;

    uint8_t pool_en;
    nnom_3d_shape_t pool_kernel;
    nnom_3d_shape_t pool_stride;
    nnom_3d_shape_t pool_pad;
    nnom_padding_t pool_padding_type;
    int16_t pool_output_shift;            // reserve

} nnom_conv2d_Accelerator_layer_t;
