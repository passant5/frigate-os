...
/* Efabless Accelerator */
#define NNOM_USING_EFABLESS_ACCELERATOR 1   // uncomment if using efabless accelerator
// #define NNOM_USING_EFABLESS_GOLDEN_MODEL 1  // uncomment if using efabless accelerator golden model
#define EFABLESS_ACCELERATOR_MAXPOOL 1      // uncomment if using efabless accelerator maxpool
