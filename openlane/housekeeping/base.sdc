...
set_output_delay 0 -clock [get_clocks wb_clk_i] [get_ports wb_dat_o[*]]
...
## CLOCK UNCERTAINITY
set wb_clk_uncer 0.240
set sck_clk_uncer 0.240
...
## MAX Transition
set_max_trans 0.750 [current_design]