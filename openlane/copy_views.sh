...
gzip -f "${PROJECT_ROOT}/gds/${MACRO}.gds"
...
# copy antenna summary
if [[ "${MACRO}" == "frigate_core" ]]; then
    cp -r "${PROJECT_ROOT}/openlane/${MACRO}/runs/${RUN_TAG}/"*"openroad-checkantennas/reports/antenna_summary.rpt" "${PROJECT_ROOT}/signoff/${MACRO}/openlane-signoff/antenna-reports/"
else
    cp -r "${PROJECT_ROOT}/openlane/${MACRO}/runs/${RUN_TAG}/"*"openroad-checkantennas-1/reports/antenna_summary.rpt" "${PROJECT_ROOT}/signoff/${MACRO}/openlane-signoff/antenna-reports/"
fi
